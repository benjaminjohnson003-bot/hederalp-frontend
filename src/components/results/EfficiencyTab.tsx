        ...
        <div className="card bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="bg-white rounded-lg p-4 border border-green-200 shadow-sm">
              <div className="text-sm text-gray-600 mb-1">Estimated APR</div>
              <div className="text-3xl font-bold text-success-600">
                {formatPercentage(data.market_context.pool_apr.estimated_position_apr)}
              </div>
              <div className="text-xs text-gray-500 mt-1">
                Based on recent trading volume and your {formatPercentage(efficiency.range_width_percent)} range
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 border border-green-100">
              ...
              <div className="text-xs text-gray-500 mt-1">
                Your liquidity concentration vs full range
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 border border-green-100">
            <div className="text-sm text-green-800">
              <strong>💡 Note:</strong> APR is estimated based on recent trading volume and your selected price range. 
              Actual returns will vary based on price movements, trading volume, and time spent in range.
            </div>
          </div>
        </div>
      )}
